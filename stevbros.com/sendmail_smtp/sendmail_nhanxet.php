...
$title = 'Comment bài viết Stevbros';
...
$body = '<h3>Chào ban quản trị website.</h3><br />Bạn &nbsp;<strong>'.$name.'</strong>&nbsp;để lại lời nhắn sau:<br /><br />'.$content.'<br /><br />Email: '.$email.'<br />Link bài viết: <a href="'.$link_baiviet.'">Xem tại đây</a>';
