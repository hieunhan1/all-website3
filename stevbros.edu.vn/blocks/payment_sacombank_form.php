...
$params = array();
$params['access_key'] = '7bf265b2f1d83dd38df9d71d3750ecc8';
$params['profile_id'] = 'stevbvn';
		...
		<table width="100%" border="0" cellpadding="0" cellspacing="20" style="margin-top:10px">
			<tr>
				<td width="180">
					...
					<p style="color:#F00; font-size:140%; text-align:center"><b><?php echo number_format($row_detail['price'],0,',','.'); ?> VNĐ</b></p>
                </td>
				<td valign="top">
                	<div style="padding-bottom:20px">
                    	<p style="font-size:140%; font-weight:bold; color:#0380FC">Chúng tôi chấp nhận các loại thẻ sau:</p>
                    ...
                    <div id="sacombank">
                        <form action="https://secureacceptance.cybersource.com/pay" method="post">
                            ...
                            <input type="submit" id="submit" name="submit" value="THANH TOÁN" style="width:244px; height:38px; line-height:38px; color:#FFF; font-size:120%; font-weight:bold; margin-right:30px; border:none; background:url(images/chi-tiet-kh.png) no-repeat; cursor:pointer" />
                            <a href="<?php echo $row_detail['link'];?>">Chi tiết khóa học</a>
                        </form>
                    </div>
                </td>
			</tr>		
