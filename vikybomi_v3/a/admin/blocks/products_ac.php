...
$style1 = '&nbsp;';
$style2 = '&nbsp;---';
$str_query = array("SELECT id, name FROM menu ", " WHERE `delete`=0 AND lang='".$_SESSION['language']."' AND (type_id=1 OR type_id=3) AND parent_id= ", " ORDER BY `order` ASC ");
...
$form->getProperties('Giá gốc', 'price', 1, 'input_medium', $value, 8);
echo $form->DisplayProperties();
//price_km
if(@$_POST['price_km']) $value = $_POST['price_km']; else $value = $detail['price_km'];
