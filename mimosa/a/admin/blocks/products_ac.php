...
$style1 = '&nbsp;';
$style2 = '&nbsp;---';
$str_query = array("SELECT id, name FROM menu ", " WHERE `delete`=0 AND lang='{$lang}' AND type_id=3 AND parent_id= ", " ORDER BY `order` ASC ");
...
$form->getProperties('Giá', 'price', 1, 'input_medium', $value, 10);
echo $form->DisplayProperties();
//kichthuoc
if(@$_POST['kichthuoc']) $value = $_POST['kichthuoc']; else $value = $detail['kichthuoc'];
$form->getProperties('Kích thước', 'kichthuoc', 1, 'input_medium', $value, 200);
echo $form->DisplayProperties();
