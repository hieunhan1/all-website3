...
<div class="viewpost">
    ...
    <table width="100%" border="0" cellpadding="0" cellspacing="0" id="tuyendung_thongtin">
        ...
        <tr>
            <td width="200" style="border-right:dotted 1px #CCC; font-weight:bold">Vị trí tuyển dụng:</td>
...
<div id="popupContact">
    <div id="content_popup" style="padding:10px 10px 25px 25px">
...
<div id="backgroundPopup" style="background-color:#000"></div>