...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';
	...
	$where = "AND lang='".$_SESSION['language']."' AND (type_id=5 OR type_id=9)";
	...
	$views = array('','','checkbox checkbox_item','width:500px; height:400px;'); //label name class width
	...
	if($row_detail['url_hinh'] != '') $other .= '<div class="avarta"><img src="'.url_photos_image_thumb.$row_detail['url_hinh'].'" /></div>';
