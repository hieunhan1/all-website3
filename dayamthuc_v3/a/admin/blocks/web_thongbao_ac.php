...
if(!empty($_POST)){
	...
	if($check == 1) header("location:administrator.php?p=web_thongbao");
...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';
	...
	$properties = array('200',$disabled.' title="Nhấp Double Click"'); //maxlength OTHER (disabled, readonly)
	...
	$other .= '<div style="clear:both; color:#00F; line-height:20px">Icon thông báo: <strong>thongbao.jpg</strong> hoặc <strong>thongbao(1).jpg</strong> <br />
	Icon lịch khai giảng: <strong>lich-khai-giang-thang-4.png</strong> <br />
	Icon lịch thi: <strong>Thong-Bao-Le-Tot-Nghiep.jpg</strong> </div>';
	...
	$properties = array('200','title="Nhấp Double Click"'); //maxlength OTHER (disabled, readonly)
	...
	//btn_cancel
	$other = '<input type="button" name="btn_cancel" id="btn_cancel" value="Hủy" class="submit" onClick="window.location.href=\'administrator.php?p=web_thongbao\'" />';
