...
$style1 = '';
$style2 = '---';
$str_query = array("SELECT id, name FROM menu ", " WHERE type_id=3 AND parent_id= ", " ORDER BY 'order' DESC ");
...
//download_file
$orther = "onclick=\"BrowseServer('Files:/','download_file')\"";
$form->getProperties('Chọn file', 'btnBrowse', 7, 'button', 0, NULL, $orther);
$orther = $form->DisplayProperties();
//Ảnh đại diện url_hinh
if(@$_POST['download_file']) $value = $_POST['download_file']; else $value = $detail['download_file'];
$form->getProperties('Download file', 'download_file', 1, 'input_large', $value, 150, $orther);
echo $form->DisplayProperties();
...
$form->getProperties('Nội dung', 'content', 3, 'textarea', $value, 2, $orther);
echo $form->DisplayProperties();
