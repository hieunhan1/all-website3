<div id="content">
    ...
    <div id="left">
        ...
        <table width="100%" border="0" cellpadding="10" cellspacing="0" id="tuyendung">
			...
			$qr = mysql_query("SELECT name,name_rewrite,noilamviec,mucluong,date_update FROM tuyendung WHERE `delete`=0 AND status=1 AND menu_id LIKE '%,{$idMenu},%' ORDER BY date_create DESC {$limit}");
