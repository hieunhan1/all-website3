...
$style1 = '&nbsp;';
$style2 = '&nbsp;---';
$str_query = array("SELECT id, name FROM menu ", " WHERE `delete`=0 AND lang='".$_SESSION['language']."' AND (type_id=1 OR type_id=2 OR type_id=3 OR type_id=4) AND parent_id= ", " ORDER BY `order` ASC ");
...
$form->getProperties('Tóm tắt', 'description', 3, 'textarea', $value, 1, $orther);
echo $form->DisplayProperties();
