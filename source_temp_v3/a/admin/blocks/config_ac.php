...
$form->getProperties('Mã ngôn ngữ', 'lang', 1, 'input_medium', $value, 2);
echo $form->DisplayProperties();
//slogan
...
$form->getProperties('Email nhận liên hệ', 'email', 1, 'input_medium', $value, 50);
echo $form->DisplayProperties();
//footer
if(@$_POST['footer']) $value = $_POST['footer']; else $value = $detail['footer'];
$form->getProperties('Copyright', 'footer', 1, 'input_medium', $value, 200);
echo $form->DisplayProperties();
//yahoo
...
$form->getProperties('Contact footer', 'contact', 3, 'textarea', $value, 1, $orther);
echo $form->DisplayProperties();
//contact_form
$orther = "
<script>
