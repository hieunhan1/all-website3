...
$str_left .= '<div class="box_left"><div class="title_left"><a href="'.$row['url'].'"><h3>Danh mục sản phẩm</h3></a></div>';
$qr2 = $tc->menu($menu_root,3);
...
elseif($row_detail['price']!=0) $price = '<div class="sp_price_ban">Giá: <b>'.number_format($row_detail['price'],'0',',','.').' VNĐ</b></div>'.$buy;
...
if(mysql_num_rows($qr) > 0){
	...
	$item_product = '<hr /><div style="clear:both; height:10px"></div> <div class="other_product">Sản phẩm cùng loại</div>'.$item_product;
}
