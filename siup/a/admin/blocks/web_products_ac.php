...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';
	...
	$where = "AND lang='{$lang}' AND (type_id=1 OR type_id=3)";
	...
	$views = array('Giá gốc','price','input_medium'); //label id&name class style
    $form->getProperties('1',$values,$properties,$views);
	echo $form->DisplayProperties();
	
	//price_km
	$values = $row_detail['price_km'];
	$properties = array('7'); //maxlength OTHER (disabled, readonly) 
	$views = array('Giá KM','price_km','input_medium'); //label id&name class style
    $form->getProperties('1',$values,$properties,$views);
	echo $form->DisplayProperties();
	...
	$properties = ''; //disabled, readonly
	$views = array('Thông tin ngắn','dactinh','textarea'); //label id&name class colspan
