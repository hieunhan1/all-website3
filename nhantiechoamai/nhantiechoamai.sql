...
-- 
-- Host: localhost
-- Generation Time: Dec 11, 2013 at 11:21 AM
...
INSERT INTO `menu` VALUES (2, 'Nhận xét của thực khách', 'nhan-xet-cua-thuc-khach', 'nhan-xet-cua-thuc-khach/', '', 'Nhận xét của thực khách', 'Nhận xét của thực khách', 'Nhận xét của thực khách', 1, 9, ',6,', 'vi', 0, 0, 1, '2013-10-09 15:38:02', '2013-10-09 10:35:41', 'admin', 'admin', 0);
INSERT INTO `menu` VALUES (3, 'Trang chủ sản phẩm', 'trang-chu-san-pham', 'trang-chu-san-pham/', '', 'Trang chủ sản phẩm', 'Trang chủ sản phẩm', 'Trang chủ sản phẩm', 1, 3, ',6,', 'vi', 0, 0, 1, '2013-10-09 15:38:25', '2013-10-09 16:26:49', 'admin', '', 1);
INSERT INTO `menu` VALUES (4, 'Trang chủ liên hệ', 'trang-chu-lien-he', 'trang-chu-lien-he/', '', 'Trang chủ liên hệ', 'Trang chủ liên hệ', 'Trang chủ liên hệ', 1, 8, ',6,', 'vi', 0, 0, 1, '2013-10-09 15:38:38', '2013-10-09 16:27:02', 'admin', '', 1);
...
INSERT INTO `menu` VALUES (8, 'Khuyến mãi', 'khuyen-mai', 'khuyen-mai/', '', 'Khuyến mãi', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentesque. In hastel habitasse platea dictumst.', 'Khuyến mãi', 0, 2, ',1,3,', 'vi', 0, 5, 1, '2013-10-09 15:40:21', '2013-10-09 10:10:30', 'admin', 'admin', 0);
INSERT INTO `menu` VALUES (10, 'Hình ảnh', 'thu-vien-hinh-anh', 'thu-vien-hinh-anh/', '', 'Thư viện hình ảnh', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentesque. In hastel habitasse platea dictumst.', 'Thư viện hình ảnh', 0, 4, ',1,3,', 'vi', 0, 6, 1, '2013-12-09 16:12:20', '2013-12-09 08:57:44', 'admin', 'admin', 0);
...
INSERT INTO `menu_admin` VALUES (7, 'Thư viện hình ảnh', 'photo_gallery', '', 7, 1, 0);
INSERT INTO `menu_admin` VALUES (8, 'Thư viện video', 'video', NULL, 8, 1, 0);
...
INSERT INTO `menu_type` VALUES (2, 'Dịch vụ', 0);
INSERT INTO `menu_type` VALUES (3, 'Menu tiệc', 0);
INSERT INTO `menu_type` VALUES (4, 'Thư viện ảnh', 0);
INSERT INTO `menu_type` VALUES (5, 'Thư viện video', 0);
...
INSERT INTO `photo_gallery` VALUES (104, 'Hình ảnh 1', 'thuvien-anh-1.jpg', 'vi', ',10,', 1, '2013-12-11 08:56:16', '2013-12-11 08:56:16', 'admin', NULL, 0);
INSERT INTO `photo_gallery` VALUES (105, 'Hình ảnh 2', 'thuvien-anh-2.jpg', 'vi', ',10,', 1, '2013-12-11 08:56:21', '2013-12-11 08:56:21', 'admin', NULL, 0);
INSERT INTO `photo_gallery` VALUES (106, 'Hình ảnh 3', 'thuvien-anh-3.jpg', 'vi', ',10,', 1, '2013-12-11 08:56:26', '2013-12-11 08:56:26', 'admin', NULL, 0);
...
INSERT INTO `products` VALUES (6, 'Menu tiệc cưới trọn gói 01', 'menu-tiec-cuoi-tron-goi-01', 'menu-tiec-1.jpg', '1 triệu', 'Lorem ipsum dolor sit amet, consectet adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellent. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante. In hacei haasse platea dictumst.\r\n', '<ol>\r\n	<li>Sắc Cầm Hòa Hợp - Mực Bách Hoa - Nem Cua Bể</li>\r\n	<li>Gà Nướng Cung Đình</li>\r\n	<li>Cua Lột Sốt Me Tươi&nbsp;&nbsp; &nbsp;</li>\r\n	<li>Tôm Hoàng Kim</li>\r\n	<li>Lẩu Cá Tầm&nbsp;&nbsp; &nbsp;</li>\r\n	<li>Tráng Miệng: Trái Cây&nbsp;&nbsp; &nbsp;</li>\r\n</ol>\r\n', '<p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellent. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante. In hacei haasse platea dictumst.</p>\r\n\r\n<p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellent. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante. In hacei haasse platea dictumst.</p>\r\n\r\n<p>Lorem ipsum dolor sit amet, consectet adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellent. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante. In hacei haasse platea dictumst.</p>\r\n\r\n<p>&nbsp;</p>\r\n', 'Menu tiệc cưới trọn gói 01', 0, 'vi', ',6,', 1, '2013-12-10 16:38:24', '2013-12-10 17:51:49', 'admin', 'admin', 0);
...
INSERT INTO `slider_banner` VALUES (5, 'Thư viện hình ảnh', 'thu-vien-hinh-anh.jpg', 'javascript:;', '', 'vi', 1, ',10,', 1, '2013-12-11 08:44:57', '2013-12-11 10:09:28', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (6, 'Thông tin liên hệ', 'thu-vien-hinh-anh.jpg', 'javascript:;', '', 'vi', 1, ',9,', 1, '2013-12-11 10:05:32', '2013-12-11 10:07:25', 'admin', '', 0);
INSERT INTO `slider_banner` VALUES (7, 'Thông tin LIÊN HỆ', 'image-6.jpg', 'lien-he/', '<p>Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentes. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante.&nbsp;</p>\r\n', 'vi', 2, '', 1, '2013-12-11 10:21:30', '2013-12-06 10:24:52', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (8, 'Voucher MỖI NGÀY', 'image-5.jpg', 'javascript:;', '<p>Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentes. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante.&nbsp;</p>\r\n', 'vi', 2, '', 1, '2013-12-11 10:22:12', '2013-12-07 10:24:41', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (9, 'Thông tin KHUYẾN MÃI', 'image-4.jpg', 'khuyen-mai/', '<p>Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentes. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante.&nbsp;</p>\r\n', 'vi', 2, '', 1, '2013-12-11 10:22:42', '2013-12-08 10:24:31', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (10, 'Giới thiệu VỀ CHÚNG TÔI', 'image-3.jpg', 'gioi-thieu/gioi-thieu-nhan-tiec-hoa-mai.html', '<p>Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentes. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante.&nbsp;</p>\r\n', 'vi', 2, '', 1, '2013-12-11 10:23:11', '2013-12-09 10:24:26', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (11, 'Dịch vụ TRỌN GÓI', 'image-2.jpg', 'dich-vu-tron-goi/', '<p>Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentes. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante.&nbsp;</p>\r\n', 'vi', 2, '', 1, '2013-12-11 10:23:42', '2013-12-10 10:24:22', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (12, 'Danh sách MENU TIỆC', 'image-1.jpg', 'menu-tiec/', '<p>Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentes. In hastel habitasse platea dictumst. Ut arcu. Maecenas sed ante.&nbsp;</p>\r\n', 'vi', 2, '', 1, '2013-12-11 10:24:02', '2013-12-11 10:24:02', 'admin', NULL, 0);
INSERT INTO `slider_banner` VALUES (13, 'Mai Phương Thúy 1', 'image-7.jpg', 'javascript:;', '<p>Maecenas sed ante. In hacei haasse platea dictumst. Cum sociis natoque penatibus et magnis dis enarturient montes, nascetur ridiculus mus. Proin semper nisi puinar nunc commodo imperdiet. Integer pede. Morbi eu nisl. Praesent purus. Aliquam nequate. Aenean urna. Quisque placerat erat quis neque.</p>\r\n\r\n<p><a href="http://kenh14.vn/fashion/mai-phuong-thuy-co-sai-lam-khi-doi-phong-cach-ca-tinh-2013121006173713.chn">_ HH Mai Phương Thúy</a></p>\r\n', 'vi', 3, ',2,', 1, '2013-12-11 10:37:11', '2013-12-11 10:43:57', 'admin', 'admin', 0);
INSERT INTO `slider_banner` VALUES (14, 'Mai Phương Thúy 2', 'image-7.jpg', 'javascript:;', '<p>Maecenas sed ante. In hacei haasse platea dictumst. Cum sociis natoque penatibus et magnis dis enarturient montes, nascetur ridiculus mus. Proin semper nisi puinar nunc commodo imperdiet. Integer pede. Morbi eu nisl. Praesent purus. Aliquam nequate. Aenean urna. Quisque placerat erat quis neque.</p>\r\n\r\n<p><a href="http://kenh14.vn/fashion/mai-phuong-thuy-co-sai-lam-khi-doi-phong-cach-ca-tinh-2013121006173713.chn">_ HH Mai Phương Thúy</a></p>\r\n', 'vi', 3, ',', 0, '2013-12-11 10:43:29', '2013-12-11 10:43:50', 'admin', '', 0);
...
INSERT INTO `slider_banner_position` VALUES (1, 'Slider width 940px', 0);
INSERT INTO `slider_banner_position` VALUES (2, 'Event home 290px', 0);
INSERT INTO `slider_banner_position` VALUES (3, 'Khác', 0);
...
INSERT INTO `users` VALUES (25, 'Admin', 'admin', 'e10adc3949ba59abbe56e057f20f883e', ',1,2,3,4,6,7,8,13,14,15,', ',1,2,3,4,6,7,8,13,14,15,', 1, 1, NULL, 0, '2011-09-21 16:42:26', NULL, 1, '2013-06-14 00:00:00', '0000-00-00 00:00:00', 'admin', 'admin', 0);
...
INSERT INTO `video` VALUES (1, 'Video giới thiệu nhà hàng', 'video-gioi-thieu-nha-hang', 'image-1.jpg', 'http://www.youtube.com/embed/Lqvbzxya_Fo', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentesque. In hastel habitasse platea dictumst.', '', '2013-12-11 09:38:52', '2013-12-11 09:38:52', 1, 'Video giới thiệu nhà hàng', 0, 'vi', ',11,', 'admin', NULL, 0);
INSERT INTO `video` VALUES (2, 'Video giới thiệu món ăn nhà hàng', 'video-gioi-thieu-mon-an-nha-hang', 'image-2.jpg', 'http://www.youtube.com/embed/Lqvbzxya_Fo', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentesque. In hastel habitasse platea dictumst.', '', '2013-12-11 09:39:07', '2013-12-11 09:39:07', 1, 'Video giới thiệu món ăn nhà hàng', 0, 'vi', ',11,', 'admin', NULL, 0);
INSERT INTO `video` VALUES (3, 'Video giới thiệu món ăn', 'video-gioi-thieu-mon-an', 'image-3.jpg', 'http://www.youtube.com/embed/Lqvbzxya_Fo', 'Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vivamus convis dapibus magna. Proin eu justo ut massa molestie pellentesque. In hastel habitasse platea dictumst.', '<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n\r\n<p>&nbsp;</p>\r\n', '2013-12-11 09:39:18', '2013-12-11 10:49:19', 1, 'Video giới thiệu món ăn', 0, 'vi', ',11,', 'admin', 'admin', 0);
INSERT INTO `video` VALUES (4, 'Giới thiệu Hoa Mai', '', 'image-1.jpg', '//www.youtube.com/embed/Rsbs3VFLUCI', 'Quisque placerat erat quis neque. Lorem ipsum dolor sit amet, consectetuer adipiscing elit. Vivamus convis dapibus magna. ', NULL, '2013-12-11 11:20:30', '2013-12-11 11:20:30', 1, NULL, 0, 'vi', ',11,', 'admin', NULL, 0);
