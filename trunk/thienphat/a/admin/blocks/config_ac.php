...
$form->getProperties('Product home page', 'max_picture', 1, 'input_medium', $value, 2);
echo $form->DisplayProperties();*/
//max_video
if(@$_POST['max_video']) $value = $_POST['max_video']; else $value = $detail['max_video'];
$form->getProperties('Product home page', 'max_video', 1, 'input_medium', $value, 2);
echo $form->DisplayProperties();
//footer
...
$form->getProperties('Email nhận liên hệ', 'yahoo', 1, 'input_medium', $value, 30);
echo $form->DisplayProperties();
//tel
...
$form->getProperties('Trang liên hệ', 'contact_form', 3, 'textarea', $value, 1, $orther);
echo $form->DisplayProperties();
