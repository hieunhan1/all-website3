...
<table width="100%" border="0" cellpadding="0" cellspacing="10" style="margin-bottom:50px">';
	...
	$where = "AND lang='".$_SESSION['language']."' AND (type_id=9 OR type_id=6)";
	...
	if($row_detail['url_hinh'] != '') $other .= '<div class="avarta"><img src="'.url_video_image_thumb.$row_detail['url_hinh'].'" /></div>';
