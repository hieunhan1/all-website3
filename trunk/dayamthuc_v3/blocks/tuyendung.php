    ...
    <div id="content_popup">
        ...
        <table width="100%" border="0" cellpadding="0" cellspacing="15" id="form_nop_hs">
        	...
        	<tr>
            	...
            	<td><textarea name="content" class="text_dangky" style="height:200px; overflow:auto; resize:none" placeholder="Nhập chi tiết kinh nghiệm làm việc (Lưu ý: Gõ có dấu)."></textarea><br /><span id="kinhnghiem" class="error"></span></td>
            </tr>
        	<tr>
