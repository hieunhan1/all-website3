...
<head>
 ...
 <title>784 - Air cargo tracking result - track-trace</title>
  ...
  <div class="navbar-inner">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="navbar-text">
            &nbsp;Origin: <strong>China Southern Airlines(CZ)</strong>
          </li>
        </ul>
...
<div class="canvas">
  ...
  <div class="tabbable tabs-left jq-multi-tab-area">
    <ul class="nav nav-tabs jq-tabs">
      ...
      <li  class="active" data-id="198"><a href="#l198" data-toggle="tab">China Southern Airlines(CZ)</a></li>
    ...
    <div class="tab-content">
          <div class="tab-pane active" id="l198">
      <div id="result">
...
<iframe  data-form="221" class="track_res_frame" id="track-res-frame" name="resframe-198" onLoad="multiFrameLoaded();">
</iframe>
...
<div id="form">
<form action="http://tang.cs-air.com/EN/WebFace/Tang.WebFace.Cargo/AgentAwbBrower.aspx" method="get" class="jq-multi-form-221" name="trackform" target="resframe-198">
  <input id="AwbPrefix" name="AwbPrefix" type="hidden" value="<?php echo $_GET['ma']; ?>" />
  <input id="AwbNo" name="AwbNo" type="hidden" value="<?php echo $_GET['number']; ?>" />
</form>
...
<div class="loader" id='siteLoader' style="display:none">
  ...
  <span id="connect" data-connecting="Connecting..."> Getting results from China Southern Airlines(CZ)</span>
