...
<head>
 ...
 <title>057 - Air cargo tracking result - track-trace</title>
  ...
  <div class="navbar-inner">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="navbar-text">
            &nbsp;Origin: <strong>AF-KL-MP Cargo(AF/KL/MP)</strong>
          </li>
        </ul>
        <ul class="nav pull-right">
          ...
          <li>
<a href="/" title="Click to return to tracking page"><i class="icon-backward icon-white"></i> Back</a>
</li>
        </ul>
      </div><!--/.nav-collapse -->
...
<div class="canvas">
  ...
  <div class="tabbable tabs-left jq-multi-tab-area">
    <ul class="nav nav-tabs jq-tabs">
      ...
      <li  class="active" data-id="164"><a href="#l164" data-toggle="tab">AF-KL-MP Cargo(AF/KL/MP)</a></li>
    ...
    <div class="tab-content">
          <div class="tab-pane active" id="l164">
      <div id="result">
...
<iframe  data-form="187" class="track_res_frame" id="track-res-frame" name="resframe-164" onLoad="multiFrameLoaded();">
</iframe>
...
<div id="form">
<form action="http://afklcargo-etracking1.traxon.com/ttwfe/search.do" method="post" class="jq-multi-form-187" name="trackform" target="resframe-164">
  <input id="awbnumber" name="awbnumber" type="hidden" value="<?php echo $_GET['ma'].'-'.$_GET['number']; ?>" />
  <input id="requester" name="requester" type="hidden" value="AFKL" />
</form>
...
<div class="loader" id='siteLoader' style="display:none">
  ...
  <span id="connect" data-connecting="Connecting..."> Getting results from AF-KL-MP Cargo(AF/KL/MP)</span>
