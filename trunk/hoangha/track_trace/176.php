...
<head>
 ...
 <title>176 - Air cargo tracking result - track-trace</title>
  ...
  <div class="navbar-inner">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="navbar-text">
            &nbsp;Origin: <strong>Emirates(EK)</strong>
          </li>
        </ul>
...
<div class="canvas">
  ...
  <div class="tabbable tabs-left jq-multi-tab-area">
    <ul class="nav nav-tabs jq-tabs">
      ...
      <li  class="active" data-id="211"><a href="#l211" data-toggle="tab">Emirates(EK)</a></li>
    ...
    <div class="tab-content">
          <div class="tab-pane active" id="l211">
      <div id="result">
...
<iframe  data-form="234" class="track_res_frame" id="track-res-frame" name="resframe-211" onLoad="multiFrameLoaded();">
</iframe>
...
<div id="form">
<form action="http://skychain.emirates.com/skychain/app" method="get" class="jq-multi-form-234" name="trackform" target="resframe-211">
  <input id="PID" name="PID" type="hidden" value="WEB01-10" />
  <input id="doc_typ" name="doc_typ" type="hidden" value="AWB" />
  <input id="awb_pre" name="awb_pre" type="hidden" value="<?php echo $_GET['ma']; ?>" />
  <input id="awb_no" name="awb_no" type="hidden" value="<?php echo $_GET['number']; ?>" />
</form>
...
<div class="loader" id='siteLoader' style="display:none">
  ...
  <span id="connect" data-connecting="Connecting..."> Getting results from Emirates(EK)</span>
