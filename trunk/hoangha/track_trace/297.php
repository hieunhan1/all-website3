...
<head>
 ...
 <title>297 - Air cargo tracking result - track-trace</title>
  ...
  <div class="navbar-inner">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="navbar-text">
            &nbsp;Origin: <strong>China Airlines(CI)</strong>
          </li>
        </ul>
...
<div class="canvas">
  ...
  <div class="tabbable tabs-left jq-multi-tab-area">
    <ul class="nav nav-tabs jq-tabs">
      ...
      <li  class="active" data-id="196"><a href="#l196" data-toggle="tab">China Airlines(CI)</a></li>
    ...
    <div class="tab-content">
          <div class="tab-pane active" id="l196">
      <div id="result">
...
<iframe  data-form="219" class="track_res_frame" id="track-res-frame" name="resframe-196" onLoad="multiFrameLoaded();">
</iframe>
...
<div id="form">
<form action="https://cargo.china-airlines.com/CCNet/global/cgoTrack.aspx" method="get" class="jq-multi-form-219" name="trackform" target="resframe-196">
  <input id="AWBPrefix" name="AWBPrefix" type="hidden" value="<?php echo $_GET['ma']; ?>" />
  <input id="AWBNumber" name="AWBNumber" type="hidden" value="<?php echo $_GET['number']; ?>" />
</form>
...
<div class="loader" id='siteLoader' style="display:none">
  ...
  <span id="connect" data-connecting="Connecting..."> Getting results from China Airlines(CI)</span>
