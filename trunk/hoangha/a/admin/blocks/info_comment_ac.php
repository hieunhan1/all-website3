...
//info_id
if(@$_POST['info_alias']) $value = $_POST['info_alias']; else $value = $detail['info_alias'];
$form->getProperties('Bài viết', 'info_alias', 1, 'input_medium', $value, 8,'<div id="name_info" style="color:blue"></div>');
echo $form->DisplayProperties();
