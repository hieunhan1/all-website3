...
$form->getProperties('Kinh nghiệm làm việc', 'content', 3, 'textarea', $value, 3, $orther);
echo $form->DisplayProperties();

$qr = mysql_query("SELECT name,name_rewrite FROM tuyendung WHERE id='{$detail['tuyendung_id']}' ");
$row = mysql_fetch_array($qr);
echo '<tr><td colspan="2" style="font-weight:bold; padding:15px">Xem thông tin tuyển dụng: <a href="http://www.dayamthuc.vn/dayamthuc_v3/tuyen-dung-dau-bep/'.$row['name_rewrite'].'.html" target="_blank">'.$row['name'].'</a></td></tr>';
