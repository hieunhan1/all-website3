...
function SendMail($frommail,$tomail,$subject,$message,$fromfullname="laptrinhwebphp.com")
{
      ...
      $admin_email 		= 'admin@netspace.edu.vn';//User duoc khai bao tren mail server
      $smtp_username 	= 'admin@netspace.edu.vn';//User duoc khai bao tren mail server
      $smtp_password 	= 'admin123';//Pass cua email nay
