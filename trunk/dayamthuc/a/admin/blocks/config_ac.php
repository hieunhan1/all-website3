...
$form->getProperties('Max số tin popup', 'max_product', 1, 'input_medium', $value, 2);
echo $form->DisplayProperties();
//max_news
...
$form->getProperties('Facebook', 'facebook', 1, 'input_medium', $value, 255);
echo $form->DisplayProperties();
//contact
$orther = "
<script>
...
$form->getProperties('Contact', 'contact', 3, 'textarea', $value, 1, $orther);
echo $form->DisplayProperties();
