...
while($row_slider = mysql_fetch_array($slider)){
	$view_slider .= '<a href="'.$row_slider['url'].'"><img src="'.url_slider_image.$row_slider['url_hinh'].'" data-thumb="'.url_slider_image_thumb.$row_slider['url_hinh'].'" alt="'.$row_slider['name'].'" title="'.$row_slider['info'].'" data-transition="slideInLeft" /></a>';
}
