...
if($total > 1){
	while($row = mysql_fetch_array($list)){
		if($row['url_hinh']!='') $img = url_bosuutap_image_thumb.$row['url_hinh']; else $img = url_no_image;
		$view_post .= '<div class="item_bosuutap">
        	<div class="img" style="background:url(\''.$img.'\') no-repeat center"></div>
