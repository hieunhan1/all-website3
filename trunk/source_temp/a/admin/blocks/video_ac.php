...
$style1 = '&nbsp;';
$style2 = '&nbsp;---';
$str_query = array("SELECT id, name FROM menu ", " WHERE `delete`=0 AND lang='{$lang}' AND type_id=6 AND parent_id= ", " ORDER BY `order` ASC ");
...
$form->getProperties('Mã video Youtube', 'link', 1, 'input_medium', $value, 250);
echo $form->DisplayProperties();
