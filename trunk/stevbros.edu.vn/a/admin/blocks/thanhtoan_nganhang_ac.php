...
//manh
if(@$_POST['manh']) $value = $_POST['manh']; else $value = $detail['manh'];
$form->getProperties('Mã ngân hàng', 'manh', 1, 'input_medium', $value, 250);
echo $form->DisplayProperties();
...
//loaithe
$value = array(0 => 'Nội địa', 1 => 'Nước ngoài');
if($_POST['loaithe'] != '') $check = $_POST['loaithe'];
else if($detail['loaithe'] != '') $check = $detail['loaithe'];
else $check = 0; //giá trị mặc định
$form->getProperties('Loại thẻ', 'loaithe', 5, $check, $value, ' &nbsp; ');
echo $form->DisplayProperties();
