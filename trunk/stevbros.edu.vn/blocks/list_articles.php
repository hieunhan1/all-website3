...
}else $view_post = $tc->navigator($row_menu_one['url'],$row_menu_one['name'],$row_menu_one['title']).'<div id="left"><div style="padding:20px; height:500px">Thông tin đang được cập nhật...</div></div>';
