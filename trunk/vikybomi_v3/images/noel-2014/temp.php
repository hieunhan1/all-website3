...
<div id="event" style="width:1302px; height:463px; margin:auto; position:relative; z-index:0">
	<div style="width:1302px; position:fixed; bottom:0">
		<img src="images/noel-2014/noel-1.gif" style="float:left" alt="Ông già Noel 2014" />
		<img src="images/noel-2014/noel-2.gif" style="float:right" alt="Cây thông Noel 2014" />
    </div>
</div>
<script type="text/javascript">
$(document).ready(function(e) {
    var width = parseInt($(window).width());
	if(width < 1200) $("#event").hide();
});
</script>