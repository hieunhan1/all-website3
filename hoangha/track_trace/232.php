...
<head>
 ...
 <title>232 - Air cargo tracking result - track-trace</title>
  ...
  <div class="navbar-inner">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="navbar-text">
            &nbsp;Origin: <strong>MASkargo(MH)</strong>
          </li>
        </ul>
...
<div class="canvas">
  ...
  <div class="tabbable tabs-left jq-multi-tab-area">
    <ul class="nav nav-tabs jq-tabs">
      ...
      <li  class="active" data-id="244"><a href="#l244" data-toggle="tab">MASkargo(MH)</a></li>
    ...
    <div class="tab-content">
          <div class="tab-pane active" id="l244">
      <div id="result">
...
<iframe  data-form="267" class="track_res_frame" id="track-res-frame" name="resframe-244" onLoad="multiFrameLoaded();">
</iframe>
...
<div id="form">
<form action="http://mhcargotrk.ccnexchange.com/trackingv2/MHTrkReply.asp" method="get" class="jq-multi-form-267" name="trackform" target="resframe-244">
  <input id="Process" name="Process" type="hidden" value="Yes" />
  <input id="awbnum" name="awbnum" type="hidden" value="<?php echo $_GET['number']; ?>" />
...
<div class="loader" id='siteLoader' style="display:none">
  ...
  <span id="connect" data-connecting="Connecting..."> Getting results from MASkargo(MH)</span>
