...
<head>
 ...
 <title>695 - Air cargo tracking result - track-trace</title>
  ...
  <div class="navbar-inner">
      ...
      <div class="nav-collapse">
        <ul class="nav">
          ...
          <li class="navbar-text">
            &nbsp;Origin: <strong>EVA Air(BR)</strong>
          </li>
        </ul>
...
<div class="canvas">
  ...
  <div class="tabbable tabs-left jq-multi-tab-area">
    <ul class="nav nav-tabs jq-tabs">
      ...
      <li  class="active" data-id="215"><a href="#l215" data-toggle="tab">EVA Air(BR)</a></li>
    ...
    <div class="tab-content">
          <div class="tab-pane active" id="l215">
      <div id="result">
...
<iframe data-frame-src="http://www.brcargo.com/ec_web/Default.aspx?Parm2=145&Parm3=?TNT_FLAG=Y&AWB_CODE=<?php echo $_GET['ma']; ?>&MAWB_NUMBER=<?php echo $_GET['number']; ?>"  data-full-screen="http://www.brcargo.com/ec_web/Default.aspx?Parm2=145&Parm3=?TNT_FLAG=Y&AWB_CODE=<?php echo $_GET['ma']; ?>&MAWB_NUMBER=<?php echo $_GET['number']; ?>"  data-form="238" class="track_res_frame" id="track-res-frame" name="resframe-215" onLoad="multiFrameLoaded();">
</iframe>
...
<div class="loader" id='siteLoader' style="display:none">
  ...
  <span id="connect" data-connecting="Connecting..."> Getting results from EVA Air(BR)</span>
  <div style="text-align: center" class="link-style"><a href="#" onClick="multiFadeSiteLoader();; return false;">Hide</a></div>
</div>

<div id="form_init">
<iframe src="http://www.brcargo.com/" name="Start" style="width:0px; height:0px; border: 0px" onLoad=multiCookieLoaded();></iframe>
