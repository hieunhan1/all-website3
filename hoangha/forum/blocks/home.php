...
if(@$_SESSION['idUser']){
	...
	if(preg_match("/,1,/", $_SESSION['idGroup'])) $create_tb = '<span class="create" style="float:right"><a href="?type=catalog&id='.$idMenu.'&create=1" style="color:#FFF">Tạo chủ đề</a></span>';
	else $create_tb = '';
    ?>
