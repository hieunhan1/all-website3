<div id="content">
	...
	$style1 = '&nbsp;';
	$style2 = '&nbsp;-- ';
	$str_query = array("SELECT id, name, date_create, date_update, `order`, status, user_create, user_update FROM forum_menu ", " WHERE `delete`=0 AND parent_id= ", " ORDER BY `order` ");
